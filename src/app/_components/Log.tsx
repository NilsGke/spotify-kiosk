...
function Logs({ spotifySession }: { spotifySession: SpotifySession }) {
  ...
  return (
    <div className="4xl:col-start-1 4xl:row-start-2 4xl:row-span-2 h-full w-full max-w-xl rounded-lg border border-zinc-800 bg-zinc-900 p-1 sm:p-3 md:p-5 lg:p-6">
      <h2 className="mb-3 h-[20px] text-center">Logs</h2>
      <div className="size-full overflow-y-scroll scrollbar scrollbar-track-transparent scrollbar-thumb-zinc-600">
